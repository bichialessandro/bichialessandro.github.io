var ASPx = {};
ASPx.SSLSecureBlankUrl = '/DXR.axd?r=1_0-fdoia';
ASPx.EmptyImageUrl = '/DXR.axd?r=1_19-fdoia';
var __aspxVersionInfo = 'Version=\'14.2.5.0\', File Version=\'14.2.5.0\', Date Modified=\'20/02/2015 11:09:06\'';
...
var ASPxClientSplitter = _aspxCreateClass(ASPxClientControl, {
 ...
 GetLayoutData: function() {
  var stateElement = this.helper.GetClientStateElement();
  return _aspxIsExists(stateElement) ? stateElement.value : "";
 },
 SetWidth: function (width) {
  this.width = width + "px";
  if(this.IsPrepared())
...
var ASPxClientSplitterPane = _aspxCreateClass(null, {
 ...
 Initialize: function () {
  ...
  if(this.collapsed) {
   ...
   else if(this.prevPane.maximizedPane != this && this.IsFirstPane())
 ...
 doLessWidth: function() {
  ...
  if(!this.collapsed && !this.autoWidth && contentContainerElement) {
   ...
   contentContainerElement.style.width = _aspxPxToInt(contentContainerElement.style.width) - scrollBarWidth + "px";
  }
 },
...
(function () {
var ASPxClientNavBar = _aspxCreateClass(ASPxClientControl, {
  ...
  for(var i = 0; i < elements.length; i++) {
   ...
   if(!elements[i].needExpandButtonReplacement) {
    ...
    if(!textElementMargin) {
     ...
     if(btnElement) {
      hasHeaderButtonOnLeft = _aspxGetElementFloat(btnElement) == "left";
 ...
 CorrectGroupHeaderTextElement: function (element) {
  ...
  if(btnElement) {
   if(!_aspxIsElementRightToLeft(this.GetMainElement()))
 ...
 CorrectGroupHeaderTextElementStyle: function (element, textElementStyle) {
  ...
  if(textElements.length > 0)
   _aspxSetStyles(textElements[0], textElementStyle, true);
 },
 ...
 GetGroupHeaderTextElementMargin: function (btnElement) {
  return btnElement ? btnElement.offsetWidth + _aspxGetLeftRightMargins(btnElement) : 0;
 },
 ...
 ChangeGroupElementsExpandState: function (groupIndex, expanded) {
  ...
  if(expanded)
   aspxGetControlCollection().AdjustControls(this.GetGroupContentElement(groupIndex), true);
  this.CorrectGroupHeaderText();
  this.ShrinkWrappedText(this.GetGroupHeaderElements, "Headers");
  this.ShrinkWrappedText(this.GetItemLinkElements, "Items");
  this.CorrectWrappedText(this.GetGroupHeaderElements, "Headers");
...
var ASPxClientNavBarGroup = _aspxCreateClass(null, {
...
var ASPxClientNavBarItem = _aspxCreateClass(null, {
...
var ASPxClientNavBarItemEventArgs = _aspxCreateClass(ASPxClientProcessingModeEventArgs, {
 constructor: function (processOnServer, item, htmlElement, htmlEvent) {
  this.constructor.prototype.constructor.call(this, processOnServer);
  this.item = item;
  this.htmlElement = htmlElement;
...
var ASPxClientNavBarGroupEventArgs = _aspxCreateClass(ASPxClientEventArgs, {
 constructor: function (group) {
  this.group = group;
 }
});
var ASPxClientNavBarGroupCancelEventArgs = _aspxCreateClass(ASPxClientProcessingModeCancelEventArgs, {
 constructor: function (processOnServer, group) {
  this.constructor.prototype.constructor.call(this, processOnServer);
  this.group = group;
 }
});
var ASPxClientNavBarGroupClickEventArgs = _aspxCreateClass(ASPxClientNavBarGroupCancelEventArgs, {
...
window.aspxNBIClick = aspxNBIClick;
window.aspxNBHMMove = aspxNBHMMove;
window.aspxNBHClick = aspxNBHClick;
})();
(function() {
 ASPxClientPanelBase = _aspxCreateClass(ASPxClientControl, {
  constructor: function(name) {
   this.constructor.prototype.constructor.call(this, name);
  ...
  getContentElement: function() {
   if(this.getContentContainerElement())
    return this.getContentContainerElement();
   if(!_aspxIsExistsElement(this.contentElement)){
    var element = this.GetMainElement();
  ...
  SetContentHtml: function(html){
   _aspxSetInnerHtml(this.getContentElement(), html);
 ...
 var InitExpandDirectionProperties = function(){
  ...
  ExpandDirectionProperties["PopupToLeft"] = { 
   hAlign: ASPxClientPopupUtils.OutsideLeftAlignIndicator, vAlign: ASPxClientPopupUtils.TopSidesAlignIndicator, 
   size: "offsetWidth", animationSize: "width" 
  };
  ExpandDirectionProperties["PopupToRight"] = { 
   hAlign: ASPxClientPopupUtils.OutsideRightAlignIndicator, vAlign: ASPxClientPopupUtils.TopSidesAlignIndicator, 
   size: "offsetWidth", animationSize: "width" 
  };
  ExpandDirectionProperties["PopupToTop"] = { 
   hAlign: ASPxClientPopupUtils.LeftSidesAlignIndicator, vAlign: ASPxClientPopupUtils.AboveAlignIndicator, 
   size: "offsetHeight", animationSize: "height" 
  };
  ExpandDirectionProperties["PopupToBottom"] = { 
   hAlign: ASPxClientPopupUtils.LeftSidesAlignIndicator, vAlign: ASPxClientPopupUtils.BelowAlignIndicator, 
   size: "offsetHeight", animationSize: "height" 
  };
 }
 ...
 ASPxClientPanel = _aspxCreateClass(ASPxClientPanelBase, {
  constructor: function(name) {
   this.constructor.prototype.constructor.call(this, name);
  ...
  InlineInitialize: function(){
   ...
   if(this.isPositionFixed()){
    ...
    var mainElement = this.GetMainElement();
    if(mainElement.style.overflow !== "" && mainElement.style.overflow !== "visible"){
     _aspxAttachEventToElement(mainElement, "scroll",
      function (evt) {
       if(typeof(aspxGetDropDownCollection) != "undefined")
        aspxGetDropDownCollection().ProcessControlsInContainer(mainElement, function(control) {
         control.HideDropDown();
        });
       if(typeof(aspxGetMenuCollection) != "undefined")
   ...
   if(btnElement){
    _aspxAttachEventToElement(btnElement, ASPxClientTouchUI.touchMouseUpEventName,
     function (evt) {
      if(_aspxGetIsLeftButtonPressed(evt))
       this.Toggle();
     }.aspxBind(this));
  ...
  AfterInitialize: function(){
   ...
   if(barElement && this.isExpandBarChangeVisibilityOnExpanding())
    _aspxAddClassNameToElement(barElement, "h");
  ...
  SetVisible: function (value) {
   if(this.clientVisible != value) {
    ...
    if(expandBarElement) _aspxSetElementDisplay(expandBarElement, value);
    this.updateFixedPanelContext();
   }
  },
  ...
  updateExpandButtonPosition: function(){
   ...
   if(isCenterPosition && expandButton.offsetWidth > 0){
    ...
    _aspxSetElementFloat(expandButton, "none");
   }
   ...
   if(correctButtonPosition) 
    this.CorrectVerticalAlignment(_aspxAdjustVerticalMargins, this.getExpandButtonElement, "Btn", true);
  },
  updateDocumentPaddings: function(){
   ...
   _aspxChangeStyleAttribute(document.documentElement, this.fixedPositionProperties.documentPadding, size + "px");
   ...
   if(expandedSize != 0){
    _aspxChangeStyleAttribute(document.documentElement, this.fixedPositionProperties.documentMargin, (documentMarginValue + expandedSize) + "px");
    _aspxChangeStyleAttribute(document.documentElement, this.fixedPositionProperties.documentMargin2, (documentMargin2Value - expandedSize) + "px");
    this.documentMarginsChanged = true;
   }
   else if(this.documentMarginsChanged){
    _aspxRestoreStyleAttribute(document.documentElement, this.fixedPositionProperties.documentMargin);
    _aspxRestoreStyleAttribute(document.documentElement, this.fixedPositionProperties.documentMargin2);
    this.documentMarginsChanged = false;
   }
  },
  updateMainElementFixedPosition: function(){
   ...
   if(barElement){
    ...
    _aspxChangeStyleAttribute(this.GetMainElement(), this.fixedPositionProperties.contentEdge, size + "px");
   }
  },
  ...
  IsExpandable: function() {
   ...
   if(this.collapseWindowWidth > 0 || this.collapseWindowHeight > 0){
    var expandBarElement = this.getExpandBarElement();
    return expandBarElement && _aspxGetCurrentStyle(expandBarElement).display !== "none";
   }
   return false;
  },
  IsExpanded: function() {
  ...
  Expand: function(preventAnimation) {
   if(ExpandedPanels[this.groupName] != this) {
    ...
    aspxGetStateController().SelectElementBySrcElement(this.GetMainElement());
    aspxGetStateController().SelectElementBySrcElement(this.getExpandButtonElement());
    ...
    aspxGetStateController().SelectElementBySrcElement(this.getExpandBarElement());
  ...
  Collapse: function(preventAnimation) {
   if(ExpandedPanels[this.groupName] == this) {
    ...
    this.collapseUnfixedPopupPanels();
    if(this.isExpandBarChangeVisibilityOnExpanding()){
     aspxGetStateController().DeselectElementBySrcElement(this.getExpandBarElement());
     this.slideAnimationExpandBarSize = this.getSlideAnimationSize(this.getExpandBarElement(), true);
     aspxGetStateController().SelectElementBySrcElement(this.getExpandBarElement());
    }
    if(!preventAnimation && this.animationType == "slide")
  ...
  collapseCore: function() {
   aspxGetStateController().DeselectElementBySrcElement(this.GetMainElement());
   aspxGetStateController().DeselectElementBySrcElement(this.getExpandButtonElement());
   if(this.isPopupExpanding() && !this.isPositionFixed())
  ...
  startFadeAnimation: function (element, isCollapsing) {
   _aspxSaveStyleAttribute(element, "opacity");
   var onComplete =  function() { this.finishFadeAnimation(element, isCollapsing); }.aspxBind(this);
   if(isCollapsing)
    ASPxAnimationHelper.fadeOut(element, onComplete, ASPxAnimationConstants.Durations.SHORT);
   else
    ASPxAnimationHelper.fadeIn(element, onComplete, ASPxAnimationConstants.Durations.SHORT);
  },
  finishFadeAnimation: function (element, isCollapsing) {
   _aspxRestoreStyleAttribute(element, "opacity");
   if(isCollapsing)
    this.collapseCore(); 
   else
    this.expandCore(); 
  ...
  startSlideAnimation: function(element, isCollapsing) {
   ...
   var offsetHeight = element.offsetHeight;
   _aspxSaveStyleAttribute(element, sizeProperty);
   _aspxChangeStyleAttribute(element, "overflow", "hidden");
   var contentContainer = this.getContentContainerElement();
   if(contentContainer) {
    _aspxChangeStyleAttribute(contentContainer, "overflow", "hidden");
    _aspxChangeStyleAttribute(contentContainer, "width", offsetWidth - _aspxGetLeftRightBordersAndPaddingsSummaryValue(element) + "px");
    _aspxChangeStyleAttribute(contentContainer, "height", offsetHeight - _aspxGetTopBottomBordersAndPaddingsSummaryValue(element) + "px");
   }
   var transitionProperties = {
    duration: ASPxAnimationConstants.Durations.SHORT, 
   ...
   var transition = ASPxAnimationHelper.createMultipleAnimationTransition(element, transitionProperties);
   ...
   if(!isCollapsing) 
    _aspxChangeStyleAttribute(element, sizeProperty, startSize + "px");
   if(this.slideAnimationPosProperty){
    ...
    if(!isCollapsing) 
     _aspxChangeStyleAttribute(element, this.slideAnimationPosProperty, startPosition + "px");
   }
   transition.Start(properties);
  },
  finishSlideAnimation: function(element, isCollapsing) {
   var sizeProperty = this.getSlideAnimationSizeProperty();
   _aspxRestoreStyleAttribute(element, sizeProperty);
   _aspxRestoreStyleAttribute(element, "overflow");
   var contentContainer = this.getContentContainerElement();
   if(contentContainer) {
    _aspxRestoreStyleAttribute(contentContainer, "overflow");
    _aspxRestoreStyleAttribute(contentContainer, "width");
    _aspxRestoreStyleAttribute(contentContainer, "height");
   }
   if(isCollapsing)
    this.collapseCore(); 
   else
  ...
  getSlideAnimationSize: function(element, fullSize) {
   ...
   if(fullSize) {
    if(sizeProperty == "offsetWidth")
     size -= _aspxGetHorizontalBordersWidth(element);
    else
     size -= _aspxGetVerticalBordersWidth(element);
   }
   else {
    if(sizeProperty == "offsetWidth")
     size -= _aspxGetLeftRightBordersAndPaddingsSummaryValue(element);
    else
     size -= _aspxGetTopBottomBordersAndPaddingsSummaryValue(element);
   }
   return size;
  },
  ...
  hasVerticalOrientation: function() {
   var float = _aspxGetElementFloat(this.GetMainElement());
  ...
  updateMainElementExpandedPosition: function(element) {
   if(element.style.width === "100%")
    _aspxChangeStyleAttribute(element, "width", (element.parentNode.offsetWidth - _aspxGetLeftRightMargins(element)) + "px");
   if(element.style.height === "100%")
    _aspxChangeStyleAttribute(element, "height", (element.parentNode.offsetHeight - _aspxGetTopBottomMargins(element)) + "px");
   _aspxChangeStyleAttribute(element, "position", "absolute");
   var barElement = this.getExpandBarElement();
   var x = ASPxClientPopupUtils.GetPopupAbsoluteX(element,
    barElement, this.expandDirectionProperties.hAlign, 0, 0, 0, false, false);
   var y = ASPxClientPopupUtils.GetPopupAbsoluteY(element,
    barElement, this.expandDirectionProperties.vAlign, 0, 0, 0, true);
   _aspxChangeStyleAttribute(element, "left", x.position + "px");
   _aspxChangeStyleAttribute(element, "top", y.position + "px");
   this.slideAnimationPosProperty = this.getSlideAnimationPosProperty(x, y);
  },
  updateMainElementCollapsedPosition: function(element) {
   _aspxRestoreStyleAttribute(element, "position");
   _aspxRestoreStyleAttribute(element, "left");
   _aspxRestoreStyleAttribute(element, "top");
   _aspxRestoreStyleAttribute(element, "width");
  ...
  checkCollapseContent: function(){
   ...
   if(this.IsExpandedInternal()){
    if(this.isPositionFixed() && !this.isElementDisplayed(this.getExpandBarElement()) && this.isElementDisplayed(this.GetMainElement()))
     this.Collapse(true);
  ...
  getContentContainerElement: function() {
   if(!_aspxIsExistsElement(this.contentContainerElement)) {
    var elements = _aspxGetChildNodesByClassName(this.GetMainElement(), "dxpnl-acc");
    if(elements.length > 0)
     this.contentContainerElement = elements[0];
   }
   return this.contentContainerElement;
  },
  getExpandBarElement: function() {
   if(!_aspxIsExistsElement(this.expandBarElement))
    this.expandBarElement = _aspxGetElementById(this.name + EXPAND_BAR_ID);
   return this.expandBarElement;
  },
  getExpandButtonElement: function() {
   if(!_aspxIsExistsElement(this.expandButtonElement))
    this.expandButtonElement = _aspxGetElementById(this.name + EXPAND_BUTTON_ID);
  ...
  getDocumentPropertyValue: function(attr){
   if(DocumentProperties[attr] === undefined){
    var currentStyle = _aspxGetCurrentStyle(document.documentElement);
    var attrValue = parseInt(_aspxGetAttribute(currentStyle, attr));
    DocumentProperties[attr] = !isNaN(attrValue) ? attrValue : 0;
   }
   return DocumentProperties[attr];
  },
  isElementDisplayed: function(element){
   return _aspxGetCurrentStyle(element).display != "none";
  }
 });
...
(function () {
 var setAttributeIfValueExists = function(element, name, value) {
  if(_aspxIsExists(value))
   _aspxSetAttribute(element, name, value);
 };
 var CssClasses = {
 ...
 var ASPxClientRoundPanel = _aspxCreateClass(ASPxClientPanelBase, {
  constructor: function (name) {
   this.constructor.prototype.constructor.call(this, name);
   this.animationDuration = 200;
   this.enableAnimation = true;
  ...
  InlineInitialize: function () {
   ...
   this.initialContentHeight = (+_aspxPxToInt(this.contentInlineHeight));
  ...
  UpdateContentHtml: function (html) {
   if (this.GetAnimationWrapper() && !(__aspxIE && __aspxBrowserMajorVersion < 8)) {
  ...
  StretchAnimationWrapper: function (size) {
   ...
   _aspxSetStyles(contentWrapper, { display: "table", height: "0px" });
   var width = contentWrapper.offsetWidth;
   var height = contentWrapper.offsetHeight;
   _aspxRemoveStyleAttribute(contentWrapper, "height");
   _aspxRemoveStyleAttribute(contentWrapper, "display");
  ...
  UpdateContentHeight: function () {
   if (!_aspxPxToInt(this.contentInlineHeight) || !this.GetContentWrapper())
    return;
   var contentWrapper = this.GetContentWrapper();
   var height = _aspxPxToInt(this.contentInlineHeight);
   _aspxSetStyles(contentWrapper, { display: "inline-block", height: "auto" });
  ...
  SetCollapsed: function (collapsed) {
   if (this.IsCollapsingAllowed() && this.GetCollapsed() != collapsed) {
    this.collapsed = collapsed;
    this.GetHiddenField().value = collapsed ? 1 : 0;
  ...
  switchButtonAppearance: function() {
   ...
   var styles = {};
   if(_aspxIsExists(props.so.spriteBackground))
    styles.background = props.so.spriteBackground;
   if(_aspxIsExists(props.w))
    styles.width = props.w;
   if(_aspxIsExists(props.h))
    styles.height = props.h;
   if(_aspxIsExists(props.so.spriteCssClass))
    styles.className = props.so.spriteCssClass;
   _aspxSetStyles(image, styles);
  },
  ...
  PrepareElementsToCollapseAnimation: function () {
   this.contentHeightBeforeCollapse = this.GetAnimationWrapper().offsetHeight;
   _aspxRemoveStyleAttribute(this.GetContentElement(), "height");
  ...
  CompleteExpanding: function () {
   ...
   if (this.tableInlineHeight)
    _aspxSetStyles(this.GetMainElement(), { height: this.tableInlineHeight });
   if (this.contentInlineHeight)
    _aspxSetStyles(this.GetContentElement(), { height: this.contentInlineHeight });
   this.UpdateContentHeight();
  },
